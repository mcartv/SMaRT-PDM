...
exports.getScholarshipPrograms = async (req, res) => {
    try {
        ...
        console.error('GET SCHOLARSHIP PROGRAMS ERROR:', err.message);
...
exports.createScholarshipProgram = async (req, res) => {
    try {
        ...
        console.error('CREATE SCHOLARSHIP PROGRAM ERROR:', err.message);
        res.status(500).json({ error: err.message });
    }
};
...
exports.updateScholarshipProgram = async (req, res) => {
    try {
        ...
        console.error('UPDATE SCHOLARSHIP PROGRAM ERROR:', err.message);
        res.status(500).json({ error: err.message });
    }
};