...
export default function LandingInstitutionHeader({ theme }) {
  return (
    <header className="h-20 border-b-4 bg-[#f7f8f4] sm:h-24" style={{ borderBottomColor: theme.accent }}>
      <div className="flex h-full w-full items-center justify-between gap-4 px-5 py-3 md:px-8 lg:px-10">
