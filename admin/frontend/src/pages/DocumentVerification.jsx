          ...
          <div className="flex min-w-0 flex-col gap-5">
            ...
            <div className="max-w-full rounded-2xl border border-stone-200/80 bg-white/80 p-3 shadow-sm sm:p-4">
              <div className="flex w-full flex-wrap items-end gap-3 sm:gap-4">
                <label className="flex min-w-[210px] flex-1 flex-col gap-1.5 sm:max-w-[260px]">
                ...
                <Button
                  ...
                  className="mb-5 h-10 shrink-0 whitespace-nowrap rounded-lg border border-[var(--portal-base)] bg-[var(--portal-base)] px-5 text-[13px] font-semibold text-white shadow-sm transition hover:brightness-95 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-[var(--portal-sub)] focus-visible:ring-offset-2 disabled:border-stone-200 disabled:bg-stone-100 disabled:text-stone-400 disabled:shadow-none sm:min-w-[160px]"
                >
                  {runningIotOcr ? (
                    <>
