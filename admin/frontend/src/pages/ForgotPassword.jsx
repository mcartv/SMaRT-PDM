            ...
            <form onSubmit={handleReset} className="space-y-5">
                ...
                <div className="grid grid-cols-1 gap-1 rounded-xl bg-stone-50 p-3">
                    {passwordChecks.map((item) => (
                        <div
                            key={item.label}
                            className={`text-[11px] font-medium ${item.valid ? 'text-green-700' : 'text-stone-400'
                                }`}
                        >
                ...
                <div className="space-y-1.5">
                    ...
                    {confirmPass && !passwordsMatch && (
                        <p className="ml-1 text-[11px] font-medium text-red-600">
    ...
    const renderDoneStep = () => (
        <div className="text-center">
            ...
            <p className="text-stone-500 text-sm mt-2 mb-8">
                You can now sign in with your new admin password.
            </p>
