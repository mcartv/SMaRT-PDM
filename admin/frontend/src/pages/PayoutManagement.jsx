...
export default function PayoutManagement() {
  ...
  const displayedBatches = useMemo(() => {
    return activeSection === 'archived' ? archivedBatches : activeBatches;
  ...
  const filteredSelectedBatchScholars = useMemo(() => {
    ...
    return filterScholarsByOpening(selectedBatch.scholars, selectedBatch.opening_id);
  }, [selectedBatch]);
  ...
  const renderBatchCard = (b) => {
    ...
    const pending = scholars.filter((s) => s.release_status === 'Pending').length;
          ...
          <div className="flex h-full flex-col gap-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              <div className="rounded-lg bg-stone-50 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-stone-500">Released</p>
                <p className="mt-0.5 text-sm font-semibold text-stone-900">{released}</p>
              </div>
              <div className="rounded-lg bg-stone-50 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-stone-500">Pending</p>
                <p className="mt-0.5 text-sm font-semibold text-stone-900">{pending}</p>
              </div>
              <div className="rounded-lg bg-stone-50 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-stone-500">Absent</p>
                <p className="mt-0.5 text-sm font-semibold text-stone-900">{absent}</p>
              </div>
              <div className="rounded-lg bg-stone-50 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-stone-500">On Hold</p>
                <p className="mt-0.5 text-sm font-semibold text-stone-900">{onHold}</p>
              </div>
            </div>
