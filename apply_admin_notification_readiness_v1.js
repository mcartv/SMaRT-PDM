...
const PATCH_NAME = 'SMaRT-PDM Admin Notification + Readiness UI v1';
const TARGETS = {
...
function main() {
  ...
  const backupDir = path.join(repoRoot, '.smart-pdm-patch-backup', `notification-readiness-${Date.now()}`);
