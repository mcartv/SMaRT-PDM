...
console.log('SMaRT-PDM Admin Realtime Audit v2');
...
const rollbackRoot = fs.mkdtempSync(
  path.join(os.tmpdir(), 'smartpdm-admin-realtime-audit-v2-')
);
...
try {
  ...
  console.error(
    '\nAdmin Realtime Audit v2 failed. Restoring previous files...'
  );
