...
router.post('/rooms/:roomId/members', protect, groupRemovalController.removeMember, messageController.addRoomMembers);
router.delete('/rooms/:roomId/members/:memberId', protect, groupRemovalController.removeMember);
