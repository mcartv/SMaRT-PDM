...
class AppRouter {
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.applicationFormPreview:
        return _buildProtectedRoute(
          settings,
          (_) => const ApplicantAccessGate(
            routeName: AppRoutes.applicationFormPreview,
            child: ApplicationFormPreviewScreen(),
          ),
        );
  ...
  static NewApplicantScreen _buildNewApplicantScreen(
    ...
    return NewApplicantScreen(
      ...
      editExistingApplication: payload['editExistingApplication'] == true,
    );
  }
