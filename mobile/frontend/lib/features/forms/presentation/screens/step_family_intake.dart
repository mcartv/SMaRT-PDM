...
class _StepFamilyState extends State<StepFamily> {
  ...
  void initState() {
    ...
    final normalizedResidencyDuration = _normalizeResidencyDuration(
      widget.data.parentMarilaoResidencyDuration,
    );
    parentMarilaoResidencyDurationController = TextEditingController(
      text: normalizedResidencyDuration,
    );
    if (normalizedResidencyDuration.isNotEmpty) {
      widget.data.parentMarilaoResidencyDuration = normalizedResidencyDuration;
    }
    ...
    final previousTown = widget.data.parentPreviousTownMunicipality.trim();
    selectedParentPreviousTown = previousTown.isEmpty ? null : previousTown;
  ...
  static const Map<String, String> _residencyDurationOptions = {
    '0': 'Less than a year',
    '5': '1-5 years',
    '10': '6-10 years',
  ...
  String _normalizeResidencyDuration(String value) {
    ...
    for (final entry in _residencyDurationOptions.entries) {
