...
class AppFieldValidators {
  ...
  /// Baseline validator for required application text fields.
  ///
  /// Leading/trailing whitespace is ignored so values containing only spaces
  ...
  static String? requiredText(
    ...
    if (minLength != null && text.length < minLength) {
      return '$label must contain at least $minLength characters.';
    }
  ...
  static String? differentEmail(String? value, {required String currentEmail}) {
  ...
  static String? philippineMobile(
    ...
    // Validate the canonical local form so the same rule works for values
    // entered as 09XXXXXXXXX, +639XXXXXXXXX, or 639XXXXXXXXX.
    final normalized = normalizePhilippineMobile(raw);
  ...
  static String? yearLevel(Object? value, {bool required = true}) {
