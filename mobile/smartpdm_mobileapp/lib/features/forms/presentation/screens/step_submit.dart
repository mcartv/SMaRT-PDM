    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            'Submitting this form will create your application for the selected scholarship. After submission, upload the required documents from Documents to continue the review process.',
            style: Theme.of(context).textTheme.labelMedium?.copyWith(
